...
namespace GMS.Core.DataAccess.Migrations
{
    ...
    [Migration("20230415195542_AddSeedDataTimeSlots")]
    partial class AddSeedDataTimeSlots
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GMS.Core.Core.Domain.Contract", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndDate = new DateTime(2024, 4, 14, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(857),
                            IsApproved = true,
                            IsDeleted = false,
                            ManagerId = new Guid("10000000-0000-0000-0006-000000000001"),
                            ProductId = new Guid("b0000000-0000-0000-0000-000000000002"),
                            StartDate = new DateTime(2023, 4, 15, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(854),
                            UserId = new Guid("00000000-0000-0000-0002-000000000001")
                        },
                        new
                        {
                            Id = new Guid("c0000000-0000-0000-0000-000000000002"),
                            EndDate = new DateTime(2024, 4, 14, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(880),
                            IsApproved = true,
                            IsDeleted = false,
                            ManagerId = new Guid("10000000-0000-0000-0006-000000000001"),
                            ProductId = new Guid("b0000000-0000-0000-0000-000000000003"),
                            StartDate = new DateTime(2023, 4, 15, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(880),
                            UserId = new Guid("00000000-0000-0000-0002-000000000001")
                        },
                        new
                        {
                            Id = new Guid("c0000000-0000-0000-0000-000000000003"),
                            EndDate = new DateTime(2024, 4, 14, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(893),
                            IsApproved = true,
                            IsDeleted = false,
                            ManagerId = new Guid("10000000-0000-0000-0006-000000000002"),
                            ProductId = new Guid("b0000000-0000-0000-0000-000000000006"),
                            StartDate = new DateTime(2023, 4, 15, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(892),
                            UserId = new Guid("00000000-0000-0000-0002-000000000002")
                        },
                        new
                        {
                            Id = new Guid("c0000000-0000-0000-0000-000000000004"),
                            EndDate = new DateTime(2024, 4, 14, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(902),
                            IsApproved = true,
                            IsDeleted = false,
                            ManagerId = new Guid("10000000-0000-0000-0006-000000000002"),
                            ProductId = new Guid("b0000000-0000-0000-0000-000000000008"),
                            StartDate = new DateTime(2023, 4, 15, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(901),
                            UserId = new Guid("00000000-0000-0000-0002-000000000002")
                        },
                        new
                        {
                            Id = new Guid("c0000000-0000-0000-0000-000000000005"),
                            EndDate = new DateTime(2024, 4, 14, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(912),
                            IsApproved = false,
                            IsDeleted = false,
                            ManagerId = new Guid("10000000-0000-0000-0006-000000000003"),
                            ProductId = new Guid("b0000000-0000-0000-0000-000000000009"),
                            StartDate = new DateTime(2023, 4, 15, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(911),
                            UserId = new Guid("00000000-0000-0000-0002-000000000003")
                        },
                        new
                        {
                            Id = new Guid("c0000000-0000-0000-0000-000000000006"),
                            EndDate = new DateTime(2024, 4, 14, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(926),
                            IsApproved = false,
                            IsDeleted = false,
                            ManagerId = new Guid("10000000-0000-0000-0006-000000000003"),
                            ProductId = new Guid("b0000000-0000-0000-0000-00000000000a"),
                            StartDate = new DateTime(2023, 4, 15, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(925),
                            UserId = new Guid("00000000-0000-0000-0002-000000000003")
                        },
                        new
                        {
                            Id = new Guid("c0000000-0000-0000-0000-000000000007"),
                            EndDate = new DateTime(2024, 4, 14, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(935),
                            IsApproved = false,
                            IsDeleted = false,
                            ManagerId = new Guid("10000000-0000-0000-0006-000000000003"),
                            ProductId = new Guid("b0000000-0000-0000-0000-00000000000b"),
                            StartDate = new DateTime(2023, 4, 15, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(935),
                            UserId = new Guid("00000000-0000-0000-0002-000000000003")
                        },
                        new
                        {
                            Id = new Guid("c0000000-0000-0000-0000-000000000008"),
                            EndDate = new DateTime(2024, 4, 14, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(944),
                            IsApproved = true,
                            IsDeleted = false,
                            ManagerId = new Guid("10000000-0000-0000-0006-000000000003"),
                            ProductId = new Guid("b0000000-0000-0000-0000-00000000000c"),
                            StartDate = new DateTime(2023, 4, 15, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(943),
                            UserId = new Guid("00000000-0000-0000-0002-000000000003")
                        },
                        new
                        {
                            Id = new Guid("c0000000-0000-0000-0000-000000000009"),
                            EndDate = new DateTime(2024, 4, 14, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(952),
                            IsApproved = true,
                            IsDeleted = false,
                            ManagerId = new Guid("10000000-0000-0000-0006-000000000003"),
                            ProductId = new Guid("b0000000-0000-0000-0000-00000000000d"),
                            StartDate = new DateTime(2023, 4, 15, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(952),
                            UserId = new Guid("00000000-0000-0000-0002-000000000003")
                        },
                        new
                        {
                            Id = new Guid("c0000000-0000-0000-0000-00000000000a"),
                            EndDate = new DateTime(2024, 4, 14, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(963),
                            IsApproved = true,
                            IsDeleted = false,
                            ManagerId = new Guid("10000000-0000-0000-0006-000000000003"),
                            ProductId = new Guid("b0000000-0000-0000-0000-00000000000e"),
                            StartDate = new DateTime(2023, 4, 15, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(962),
                            UserId = new Guid("00000000-0000-0000-0002-000000000003")
                        },
                        new
                        {
                            Id = new Guid("c0000000-0000-0000-0000-00000000000b"),
                            EndDate = new DateTime(2024, 4, 14, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(971),
                            IsApproved = true,
                            IsDeleted = false,
                            ManagerId = new Guid("10000000-0000-0000-0006-000000000003"),
                            ProductId = new Guid("b0000000-0000-0000-0000-00000000000f"),
                            StartDate = new DateTime(2023, 4, 15, 19, 55, 42, 27, DateTimeKind.Utc).AddTicks(971),
                            UserId = new Guid("00000000-0000-0000-0002-000000000002")
                        });
                });
